...
class LogicExtClient extends $grpc.Client {
  ...
  static final _$getUserGroups =
      $grpc.ClientMethod<$1.GetUserGroupsReq, $1.GetUserGroupsResp>(
          '/pb.LogicExt/GetUserGroups',
          ($1.GetUserGroupsReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.GetUserGroupsResp.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.GetUserGroupsResp> getUserGroups(
      $1.GetUserGroupsReq request,
      {$grpc.CallOptions options}) {
...
abstract class LogicExtServiceBase extends $grpc.Service {
  ...
  LogicExtServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.GetUserGroupsReq, $1.GetUserGroupsResp>(
        'GetUserGroups',
        getUserGroups_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.GetUserGroupsReq.fromBuffer(value),
        ($1.GetUserGroupsResp value) => value.writeToBuffer()));
    $addMethod(
  ...
  $async.Future<$1.GetUserGroupsResp> getUserGroups_Pre($grpc.ServiceCall call,
      $async.Future<$1.GetUserGroupsReq> request) async {
  ...
  $async.Future<$1.GetUserGroupsResp> getUserGroups(
      $grpc.ServiceCall call, $1.GetUserGroupsReq request);
